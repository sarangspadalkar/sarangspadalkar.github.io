...
import { Download, Calendar, MapPin, Building, Award, Code } from 'lucide-react';
...
const Resume = () => {
    const experience = [
        ...
        },
        {
            ...
            technologies: ['Python', 'Apache Kafka', 'Elasticsearch', 'MongoDB', 'Docker']
        }
    ];
    ...
    const skills = {
        'Programming Languages': ['Node.js', 'Python', 'Go', 'Java', 'TypeScript', 'JavaScript'],
        'Databases': ['PostgreSQL', 'Redis', 'MongoDB', 'MySQL', 'Elasticsearch'],
        'Cloud & DevOps': ['AWS', 'Docker', 'Kubernetes', 'Terraform', 'Jenkins', 'Git'],
        'APIs & Services': ['REST APIs', 'GraphQL', 'gRPC', 'Microservices', 'Message Queues'],
        'Tools & Frameworks': ['Express.js', 'Django', 'Spring Boot', 'Socket.io', 'Apache Kafka']
    };
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                            Senior Backend Developer with 10+ years of experience in scalable system design
                        </p>
