...
const About = () => {
    const techStack = [
        { category: 'Languages', items: ['Node.js', 'Python', 'Go', 'Java', 'TypeScript'] },
        { category: 'Databases', items: ['PostgreSQL', 'Redis', 'MongoDB', 'MySQL', 'Elasticsearch'] },
        { category: 'Cloud & DevOps', items: ['AWS', 'Docker', 'Kubernetes', 'Terraform', 'Jenkins'] },
        { category: 'APIs & Services', items: ['REST APIs', 'GraphQL', 'gRPC', 'Microservices', 'Message Queues'] },
    ];
    ...
    const strengths = [
        {
            ...
            description: 'Building fault-tolerant systems with 99.9%+ uptime and comprehensive monitoring'
        },
        {
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300">
                            Senior Backend Developer passionate about building scalable, reliable systems
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    >
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none">
                            <p className="text-lg text-gray-600 dark:text-gray-300 mb-4">
                                With over 10 years of experience in backend development, I've had the privilege of
                                working on systems that serve millions of users across various industries. My passion
                                lies in designing and implementing scalable architectures that not only meet current
                                demands but are built to handle future growth.
                            </p>
                            <p className="text-lg text-gray-600 dark:text-gray-300 mb-4">
                                I specialize in building robust APIs, optimizing database performance, and implementing
                                cloud-native solutions. My approach combines deep technical expertise with a focus on
                                business value, ensuring that every system I build is not just technically sound but
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-300">
                                ...
                                junior developers, or exploring new technologies to stay at the forefront of backend
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-white mb-6">
                            10+ Years of Backend Excellence
                        </h2>
